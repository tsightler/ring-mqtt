...
class StreamWorkers {
    ...
    init() {
        ...
        utils.event.on('start_livestream', (deviceId, deviceName, sessionId, rtmpPublishUrl) => {
            let workerId = 0
            ...
            this.streamWorkers[workerId].liveCall.postMessage({ command: 'start', deviceName, sessionId, rtmpPublishUrl })
        })
