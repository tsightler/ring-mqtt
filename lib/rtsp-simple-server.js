    ...
    async createAllRtspPaths() {
        ...
        for (const camera of this.cameras) {
            ...
            const rtspPathConfig = JSON.stringify({
                source: 'publisher',
                runOnDemand: `node ./lib/start-stream.js ${camera.deviceId}_live ${camera.deviceTopic}/stream/state ${camera.deviceTopic}/stream/command`,
                runOnReadRestart: false,
                runOnDemandStartTimeout: 20000000000,
                runOnDemandCloseAfter: 2000000000
            })
