...
export default new class Config {
    ...
    async loadConfigEnv() {
        debug(chalk.yellow('No config file found, attempting to use environment variables for configuration'))
        debug(chalk.yellow('******************************** IMPORTANT NOTE ********************************'))
        debug(chalk.yellow('The use of environment variables for configuration is deprecated, and will be'))
        debug(chalk.yellow('removed in a future release. Current settings will automatically be migrated to'))
        debug(chalk.yellow(`${this.file} and this configuration will be used during future initializations.`))
        debug(chalk.yellow('Please make sure you have configured a persistent volume mapping as this is now'))
        debug(chalk.yellow('a requirement for all Docker based installations.'))
        debug(chalk.yellow('********************************************************************************'))
