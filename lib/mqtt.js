...
import { IPC_MQTT_PORT, IPC_MQTT_HOST } from './constants.js'
import fs from 'fs'
...
export default new class Mqtt {
    constructor() {
        ...
        netServer.listen(IPC_MQTT_PORT, IPC_MQTT_HOST)
    ...
    async init() {
        try {
            ...
            this.ipcClient = await mqttApi.connect(`mqtt://${IPC_MQTT_HOST}:${IPC_MQTT_PORT}`, {})
