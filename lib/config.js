...
export default new class Config {
    ...
    async init() {
        ...
        this.data.ring_topic = this.data.hasOwnProperty('ring_topic') ? this.data.ring_topic : DEFAULT_RING_TOPIC
        this.data.hass_topic = this.data.hasOwnProperty('hass_topic') ? this.data.hass_topic : DEFAULT_HASS_TOPIC
        this.data.enable_cameras = this.data.hasOwnProperty('enable_cameras') ? this.data.enable_cameras : DEFAULT_ENABLE_CAMERAS
        this.data.enable_modes = this.data.hasOwnProperty('enable_modes') ? this.data.enable_modes : DEFAULT_ENABLE_MODES
        this.data.enable_panic = this.data.hasOwnProperty('enable_panic') ? this.data.enable_panic : DEFAULT_ENABLE_PANIC
        this.data.disarm_code = this.data.hasOwnProperty('disarm_code') ? this.data.disarm_code : DEFAULT_DISARM_CODE
    ...
    doMqttDiscovery() {
        try {
            ...
            if (!mqttURL.port) {
                mqttURL.port = mqttURL.protocol === 'mqtts:' ? MQTTS_DEFAULT_PORT : MQTT_DEFAULT_PORT
