...
case "${APKARCH}" in
    'x86_64')
        curl -L -s https://raw.githubusercontent.com/tsightler/rtsp-simple-server/main/release-custom/rtsp-simple-server_v0.17.2-21-g43b10dc_linux_amd64.tar.gz | tar zxvf - rtsp-simple-server
        ;;
    'aarch64')
        curl -L -s https://raw.githubusercontent.com/tsightler/rtsp-simple-server/main/release-custom/rtsp-simple-server_v0.17.2-21-g43b10dc_linux_arm64v8.tar.gz | tar zxvf - rtsp-simple-server
        ;;
    'armv7')
        curl -L -s https://raw.githubusercontent.com/tsightler/rtsp-simple-server/main/release-custom/rtsp-simple-server_v0.17.2-21-g43b10dc_linux_armv7.tar.gz | tar zxvf - rtsp-simple-server
        ;;
    'armhf')
        curl -L -s https://raw.githubusercontent.com/tsightler/rtsp-simple-server/main/release-custom/rtsp-simple-server_v0.17.2-21-g43b10dc_linux_armv6.tar.gz | tar zxvf - rtsp-simple-server
        ;;
    *) 
