...
class Config {
    constructor() {
        ...
        this.data.enable_cameras = this.data?.enable_cameras ? this.data.enable_cameras : true
        this.data.enable_modes = this.data?.enable_modes ? this.data.enable_modes : false
        this.data.enable_panic = this.data?.enable_panic ? this.data.enable_panic : false
        this.data.disarm_code = this.data?.disarm_code ? this.data.disarm_code : ''
    ...
    async loadConfigEnv() {
        ...
        // When upgrading from existing deployments keep cameras disabled by default
        this.data.enable_cameras = this.data?.enable_cameras ? this.data?.enable_cameras : false
        this.data.location_ids = this.data?.location_ids ? this.data.location_ids.split(',') : []
    }
