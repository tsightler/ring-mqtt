...
Prior to Home Assistant 0.113 it was highly recommended to manually configure birth messages on the MQTT component configuration.yaml so the ring-mqtt could monitor for restarts.  The example for this setting in the documtation, and prior versions of this script, used hass/status as the topic for these messages.
